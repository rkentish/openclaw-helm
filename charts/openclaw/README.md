...
[![App Version](https://img.shields.io/badge/App_Version-2026.3.11-blue)](https://github.com/openclaw/openclaw)
[![Chart Version](https://img.shields.io/badge/Chart_Version-1.4.8-blue)](https://github.com/serhanekicii/openclaw-helm)
...
| app-template.openclawVersion | string | `"2026.3.11"` | OpenClaw image version (used by all OpenClaw containers) |
